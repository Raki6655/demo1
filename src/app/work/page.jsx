			...
			>
				...
				<div className="h-screen flex items-center justify-center">
					<div className="text-center max-w-4xl px-4">
						<h1 className="hero-text text-[4rem] lg:text-[6rem] font-bold  bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-400 leading-none mb-8">
							Our Portfolio
						</h1>
						<p className="hero-text text-md lg:text-2xl text-white/80">
